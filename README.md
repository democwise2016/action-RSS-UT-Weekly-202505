...
https://democwise2016.github.io/action-RSS-UT-Weekly-202505/
...
````bash
git clone --branch main --single-branch --depth 1 https://github.com/democwise2016/action-RSS-UT-Weekly-202505.git
````